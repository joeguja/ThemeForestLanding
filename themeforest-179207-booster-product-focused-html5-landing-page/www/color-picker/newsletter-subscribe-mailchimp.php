<?php
/*
 * Booster - MailChimp newsletter subscription script
 * (c) Web factory Ltd
 * www.webfactoryltd.com
**/

  // your MailChimp API Key
  define('MAILCHIMP_API_KEY', 'MAILCHIMP-API');
  // name of the list people are subscribing to
  define('MAILCHIMP_LIST_NAME', 'LIST-NAME');
...
/**** DO NOT EDIT BELOW THIS LINE ****/
  ...
  $retval = $api->listSubscribe($listId, $emailAddress, null, null, true, null, null, true);
